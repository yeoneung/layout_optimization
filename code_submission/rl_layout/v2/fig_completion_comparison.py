"""Plot the v5 anytime comparison and initialization coverage."""
...
def main():
    ...
    parser.add_argument("--input", default="completion_comparison_dense50_v5.json")
    parser.add_argument("--out", default="../../figs_v2/fig_completion_comparison")

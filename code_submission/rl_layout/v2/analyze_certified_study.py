"""Validate and summarize the v3 certified-decoder study.
...
def main() -> None:
    ...
    parser.add_argument("--input", type=Path, default=Path("certified_study_v3.json"))
    parser.add_argument("--output", type=Path, default=Path("certified_study_summary_v3.json"))

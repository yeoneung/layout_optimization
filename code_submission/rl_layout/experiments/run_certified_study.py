...
This script supplies the two certified-decoder experiments:
...
def main():
    ...
    p.add_argument("--out", default="certified_study.json")
    ...
    if out.exists() and not a.no_resume:
        ...
        data = {
            "metadata": {
                "purpose": "witness-certified full sweep and dense confirmation",
                "split": a.split,
